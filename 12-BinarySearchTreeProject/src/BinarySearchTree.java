...
// -------------------------------------------------------------
   public Node find(int key)      // find node with given key
	...
	//  if(root == null) return null;
      ...
      while(current != null && current.iData != key)        // while no match,
         {
   ...
   public static void main(String[] args) throws IOException
    ...
    System.out.print("Minimum: ");
     ...
     System.out.print("\n");
      ...
      Node found1 = recurFind(25, theTree.root);
      if(found1 != null)
      {
...
// -------------------------------------------------------------
   public static Node recurFind(int key,Node root)      // find node with given key
      {
	    
     if(root == null || key == root.iData)
    	 return root;
      if(key < root.iData)        
            return recurFind(key, root.leftChild);
         else                           
            return recurFind(key,root.rightChild);
...
// -------------------------------------------------------------
   public static Node nodeSuccessor(Node root)      // find node with given key
      {
	   if(root.rightChild!=null)
	    return minimum(root.rightChild);
	  // incomplete
